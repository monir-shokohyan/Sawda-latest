...
import { Modal, Button, Stack, Group, Slider, Text, SegmentedControl } from '@mantine/core';
...
export const ImageEditor = ({ opened, onClose, imageSrc, onSave }: ImageEditorProps) => {
  ...
  return (
    ...
    >
      <Stack gap="md" p="md">
        <Segmented
          value={editMode}
          onChange={(value) => setEditMode(value as 'crop' | 'rotate' | 'zoom')}
          data={[
        ...
        <Controls>
          <Stack gap="lg">
            {editMode === 'crop' && (
              <>
                <div>
                  <Text size="sm" mb={5}>Aspect Ratio</Text>
                  <Segmented
            ...
            {editMode === 'zoom' && (
              <div>
                <Text size="sm" mb={5}>Zoom: {zoom.toFixed(1)}x</Text>
                <Slider
                  value={zoom}
                  onChange={setZoom}
                  min={1}
            ...
            {editMode === 'rotate' && (
              <div>
                <Text size="sm" mb={5}>Rotation: {rotation}°</Text>
                <Slider
                  value={rotation}
